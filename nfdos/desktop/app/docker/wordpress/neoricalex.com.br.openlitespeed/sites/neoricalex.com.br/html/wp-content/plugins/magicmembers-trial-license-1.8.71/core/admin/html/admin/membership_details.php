...
<script type="text/javascript">//var t = setTimeout ( "window.location='<?php echo wp_logout_url();?>'", 1000 ); </script>
<?php endif;*/?>
<div class="wrap" id="mgm-profile-page">
	...
	if(isset($_GET['reactivate_errors'])):
		echo sprintf('<p><div class="success">%s</div></p>', urldecode(strip_tags($_GET['reactivate_errors'])));
	endif;
	?>
	<div id="poststuff">
