	...
	<?php mgm_box_top($data['module']->name. ' Settings');?>
		...
		<div class="table">
			...
			<div class="row api-options">
				<div class="cell">
					<p><b><?php _e('API Version','mgm'); ?>:</b></p>
				</div>
			</div>
			<div class="row api-options">
				<div class="cell">
					<select name="setting[api_version]" id="setting_api_version" class="width120px">
						<?php echo mgm_make_combo_options( array('2.0'=>__('2.0','mgm'),'3.0'=>__('3.0','mgm') ), $data['module']->setting['api_version'], MGM_KEY_VALUE);?>
					</select>							
					<p><div class="tips"><?php _e('PagSeguro payment api version.','mgm'); ?></div></p>
				</div>
			</div>
			<div class="row api-options">
				<div class="cell">
