...
class OwnAssets
{
	...
	public function init()
    {
	    ...
	    add_filter('wpacu_object_data', static function($wpacu_object_data) {
		    ...
		    // [wpacu_pro]
		    $wpacu_object_data['script_is_parent_alert'] = 'This JavaScript is having the following "children" depending on it (at least that\'s how it was marked): {wpacu_script_child_handles}.'."\n\n".
...
JS;
		...
		if (in_array($page, array(WPACU_PLUGIN_ID . '_assets_manager', WPACU_PLUGIN_ID . '_plugins_manager')) || (Misc::getVar('get', 'post') && Misc::getVar('get', 'action') === 'edit')) {
			// [Start] SweetAlert
			wp_enqueue_style(
