...
class mgm_eway extends mgm_payment{
	...
	function get_button_unsubscribe($options=array(), $show_heading=true, $add_form=true){
		...
		/*$heading = '';
		if( $show_heading ){
			$heading = '<span class="mgm_unsubscribe_btn_head">'.__('Unsubscribe','mgm').'</span><br>';
		}*/
...
//		}
	...
	function _setup_endpoints($end_points = array()){
		...
		$end_points_default = array(
			'test_xml_cvn'     => 'https://www.eway.com.au/gateway_cvn/xmltest/testpage.asp',// test xml cvn
			//'test_xml_cvn2'    => 'https://api.sandbox.ewaypayments.com/gateway/Xml/CvnXmlPaymentRequestHandler.ashx',// nenew w
			...
			//'test_recurring2'  => 'https://api.sandbox.ewaypayments.com/gateway/RecurringPayments/RecurringPaymentsService.asmx',
