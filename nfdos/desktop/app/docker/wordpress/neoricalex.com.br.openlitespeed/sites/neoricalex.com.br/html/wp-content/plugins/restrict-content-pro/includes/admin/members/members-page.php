...
function rcp_members_page() {
	...
	if ( ! empty( $_GET['view'] ) && 'edit' == $_GET['view'] && ! empty( $_GET['membership_id'] ) ) {
		require_once RCP_PLUGIN_DIR . 'includes/admin/memberships/edit-membership.php';
	} elseif ( ! empty( $_GET['view'] ) && 'add' == $_GET['view'] ) {
		require_once RCP_PLUGIN_DIR . 'includes/admin/memberships/add-membership.php';
	} elseif ( ! empty( $_GET['view'] ) && 'cancel-confirmation' == $_GET['view'] ) {
		require_once RCP_PLUGIN_DIR . 'includes/admin/memberships/cancel-membership.php';
	} else {
...
function rcp_memberships_list() {
	...
	include_once RCP_PLUGIN_DIR . 'includes/admin/memberships/class-memberships-table.php';
