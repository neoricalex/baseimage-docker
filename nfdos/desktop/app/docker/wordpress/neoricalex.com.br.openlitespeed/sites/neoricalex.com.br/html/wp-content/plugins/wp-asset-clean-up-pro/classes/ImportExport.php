...
class ImportExport
{
	...
	public function doExport()
	{
		...
		$exportComment = 'Exported via '.WPACU_PLUGIN_TITLE.' (v'.WPACU_PRO_PLUGIN_VERSION.') - Timestamp: '.time();
...
SQL;
		...
		header('Content-Disposition: attachment; filename="asset-cleanup-pro-exported-'.$wpacuExportFor.'-from-'.$host.'-'.$date.'.json"');
