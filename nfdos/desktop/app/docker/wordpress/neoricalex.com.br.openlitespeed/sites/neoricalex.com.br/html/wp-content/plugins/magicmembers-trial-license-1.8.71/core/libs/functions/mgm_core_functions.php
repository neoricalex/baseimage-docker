...
if( ! function_exists('mgm_import_dependency') ){
	/**
...
if( ! function_exists('mgm_get_option') ){
	/**
...
if( ! function_exists('mgm_get_config') ){
	/**
...
if( ! function_exists('mgm_get_post') ){
	/**
...
if( ! function_exists('mgm_get_available_themes') ){
	/**
...
if( ! function_exists('mgm_get_active_modules') ){
	/**
	 * Short hand to fetch active modules
	 * 
	 * @param string $type
	 * @since 2.9.0
	 */ 
	function mgm_get_active_modules($type='payment'){
		// fetch
		return mgm_get_class('system')->get_active_modules($type);
	}
}

if( ! function_exists('mgm_get_modules') ){
	/**
...
if( ! function_exists('mgm_get_module') ){
	/**
...
if( ! function_exists('mgm_get_plugins') ){
	/**
	 ...
	 * @return object
	 */
	function mgm_get_plugins($flush=false){
		// init
...
if( ! function_exists('mgm_get_plugin') ){
	/**
...
if( ! function_exists('mgm_get_utility_class') ){
	/**
