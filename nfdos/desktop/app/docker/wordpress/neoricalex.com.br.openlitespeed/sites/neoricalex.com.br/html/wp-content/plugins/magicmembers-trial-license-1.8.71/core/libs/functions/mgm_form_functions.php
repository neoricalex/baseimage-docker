...
function mgm_user_profile_form($user_id=NULL, $temp_edit=false, $args=array()) {
	...
	// append script
	$form_html .= '<script type="text/javascript">jQuery(document).ready(function(){try{mgm_date_picker(".mgm_date",false,{yearRange:"'.$yearRange.'", dateFormat: "'. mgm_get_datepicker_format() .'"});}catch(x){}});</script>';
