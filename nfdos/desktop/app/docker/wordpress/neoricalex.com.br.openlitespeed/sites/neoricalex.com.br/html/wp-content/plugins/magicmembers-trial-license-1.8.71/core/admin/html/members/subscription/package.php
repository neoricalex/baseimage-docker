<fieldset class="packgroup" id="mgm_pack_<?php echo $data['pack']['id'] ?>">
	...
	<div class="packdet_hidden" id="mgm_pack_<?php echo $data['pack']['id'] ?>_details">
		...
		<div class="table">
			...
			?>
			<div class="bhighlight">
				<div class="row">
					<div class="cell">
						<div>	
							<p class="fontweightbold"><?php _e('Custom URL','mgm');?>:</p>
							<span class="packreg-customurl">
				...
				<div class="row">
					<div class="cell">
						<div>	
							...
							<span class="packreg-wpurl">
								<?php echo add_query_arg( array('action'=>'register','package'=>$package_enc), site_url('wp-login.php') );?>
							</span>
				...
				<!-- issue #1906 -->	
				<?php if( bool_from_yn( mgm_get_setting('enable_multiple_level_purchase', 'N')) ):?>		
				<div class="row">
					<div class="cell">
						<div>	
							<p class="fontweightbold"><?php _e('Purchase another level  URL','mgm');?>:</p>
							<span class="packreg-anotherurl"><?php echo mgm_get_custom_url('transactions',true,array('action'=>'purchase_another','package'=>$package_enc,'usertoken'=>'[usertoken]'));?></span><br>
							<!--<a class="copy-packreg-anotherurl">copy</a>-->
							<div class="tips width95">
								<?php _e('Please use userwise link from user profile.', 'mgm')?>
							</div>
						</div>
					</div>
				</div>				
