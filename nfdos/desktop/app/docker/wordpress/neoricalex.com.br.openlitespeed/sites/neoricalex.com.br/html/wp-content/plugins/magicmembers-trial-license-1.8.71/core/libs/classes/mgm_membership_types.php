...
class mgm_membership_types extends mgm_object{
	...
	// set name
	public function set_name($name, $code=NULL){		
		// char limit
	...
	public function set_login_redirect($type_code, $redirect=NULL){
		// set if provided
		if($redirect){ 
	...
	public function set_login_redirects($redirects){
		// set if provided
	...
	// set one login redirect
	public function set_logout_redirect($type_code, $redirect=NULL){
		// set if provided
		if($redirect){ 
	...
	// set multiple login redirects
	public function set_logout_redirects($redirects){
		// set if provided
		if(is_array($redirects)){			
	...
	public function get_login_redirect($type_code){
		// set if provided
	...
	public function get_login_redirects(){
		// set if provided
	...
	// get one login redirect
	public function get_logout_redirect($type_code){
		// set if provided
	...
	// get all login redirects
	public function get_logout_redirects(){
		// set if provided
	...
	// check duplicate
	public function is_duplicate($type_name, $type_code=NULL){
		// return
		if(!$type_code){
	...
	// deprecated-------------------------------------------------------------
	// set multiple
	public function set_membership_types($membership_types) {
		// check
		if(is_array($membership_types)) $this->membership_types = $membership_types;
	}
	
	// add single
	public function set_membership_type($type_name, $return='bool') {
		// check duplicate value
	 ...
	 */
	public function unset_membership_type($code) {
		// deprecae
		return $this->delete($code);
	}
		
	// get code
	public function get_type_code($type){
		// return strtolower(preg_replace('/\s+/', '_', $type));
		return strtolower(preg_replace('/\W+/', '_', $type)); // which issue ?
	}
	
	// get type
	public function get_type_name($type_code){
		// def
	...
	// get nicecode
	public function get_type_nicecode($type){
	...
	// defaults
	private function _set_defaults($membership_types=false){
		// code
		$this->code        = __CLASS__;
		// name
	 ...
	 */
	public function _option_merge_callback($option_name, $current_value, $option_value) {		
