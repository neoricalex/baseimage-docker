				...
				switch($field){
					...
					case 'payment_info':			
						...
						if(!empty($value)) {						
							...
							$value = mgm_stripslashes_deep($value);
							// if there is a match
							if(isset($member->payment_info->module) && !empty($member->payment_info->module) && trim(strtolower($value)) == trim(strtolower($member->payment_info->module))) {
								$valid = true;
							}
						}
					break;
					case 'subscr_id':
						...
						if(!empty($value)) {						
							...
							$value = mgm_stripslashes_deep($value);
							// if there is a match
							if(isset($member->payment_info->subscr_id) && !empty($member->payment_info->subscr_id) && trim(strtolower($value)) == trim(strtolower($member->payment_info->subscr_id))) {
								$valid = true;
							}
						}
					break;
