...
class License
{
	...
	public function registerOption()
	{
		...
		register_setting(
			WPACU_PLUGIN_ID . '_pro_license',
			WPACU_PLUGIN_ID . '_pro_license_key'
		);
	}
    ...
    */
	public function activateLicense()
	{
		...
		if( ! check_admin_referer( WPACU_PLUGIN_ID . '_pro_nonce', WPACU_PLUGIN_ID . '_pro_nonce')) {
    ...
    */
	...
	public function deactivateLicense()
	{
		...
		wp_redirect( admin_url( 'admin.php?page=' . WPACU_PLUGIN_ID . '_license' ) );
		exit();
	}
