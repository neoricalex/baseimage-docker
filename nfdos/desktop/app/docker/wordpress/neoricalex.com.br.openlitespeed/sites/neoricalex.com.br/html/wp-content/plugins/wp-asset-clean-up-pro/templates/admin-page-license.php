...
<div class="wpacu-wrap wpacu-license-area">
    ...
    <form id="wpacu-license-form" method="post" action="options.php">
		<?php settings_fields( WPACU_PLUGIN_ID . '_pro_license'); ?>
                    ...
                    <td>
                        <p style="margin: 0;"><label class="description" for="<?php echo WPACU_PLUGIN_ID . '_pro_license_key'; ?>"><em><?php _e('Add the license key of 32 characters you received in your purchase email receipt.', 'wp-asset-clean-up'); ?></em></label></p>
                            ...
                            <div class="wpacu-license-action-btn-area">
                                <input type="hidden" name="edd_license_activate" value="1" />
                ...
                */
                ...
                <tr valign="top">
                    ...
                    <td>
                        ...
                        <div class="wpacu-license-action-btn-area">
                            <input type="hidden" name="edd_license_deactivate" value="1" />
                            <input type="submit" class="button-secondary" name="edd_license_deactivate_btn" id="edd_license_deactivate_btn" value="<?php _e('Deactivate License', 'wp-asset-clean-up'); ?>"/>
                            <span class="wpacu-license-spinner"><img alt="" src="<?php echo includes_url('images/spinner-2x.gif'); ?>" /></span>
                        </div>
