...
class mgm_pagseguro extends mgm_payment{	
	...
	function settings_update(){
		...
		switch($_POST['setting_form']){
			...
			// from main				
				...
				$this->setting['api_version']    = $_POST['setting']['api_version'];// 2.0 | 3.0	
    ...
    */
	...
	function _default_setting(){
		...
		$this->setting['api_version']    = '2.0';// 2.0 | 3.0
	...
	function _filter_api_postdata($post_data, $join=false){
		...
		$fields_sent = array(
			'email', 'token', 'currency', 'charset', 'itemId1', 'itemDescription1', 'itemAmount1',
