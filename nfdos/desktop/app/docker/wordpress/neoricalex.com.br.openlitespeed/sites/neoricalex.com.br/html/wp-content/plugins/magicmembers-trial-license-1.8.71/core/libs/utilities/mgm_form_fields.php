...
class mgm_form_fields{
	...
	public function field_username_callback($field,$name,$value){
		...
		if($this->get_config('wordpres_form')){
			// hide default field
			$html.= '<script type="text/javascript">jQuery(document).ready(function(){jQuery("#user_login").parent().remove();});</script>';
		}
		// return
		return $html;
	}
	...
	public function field_email_callback($field,$name,$value){			
		...
		if($this->get_config('wordpres_form')){
			// hide default field
			$html.= '<script type="text/javascript">jQuery(document).ready(function(){jQuery("#user_email").parent().remove();});</script>';
		}
		// return
		return $html;
	}
