			...
			mgm_get_membership_types=function(){
				...
				jQuery('#membership_types_list').load('admin-ajax.php?action=mgm_admin_ajax_action&page=mgm.admin.members&method=membership_types_list', function(){
					...
					jQuery("#membership_types_list :checkbox[name='remove_membership_type[]']").bind('click', function(){				
						//jQuery("select[name='move_membership_type_to["+jQuery(this).val().toString().keyslug()+"]']").attr('disabled', !jQuery(this).prop('checked'));
						jQuery("select[name='move_membership_type_to["+jQuery(this).val()+"]']").attr('disabled', !jQuery(this).prop('checked'));
					});	
					// enable/disable login redirect					
					jQuery("#membership_types_list :checkbox[name='update_login_redirect_url[]']").bind('click', function(){				
						//jQuery(":input[name='login_redirect_url["+jQuery(this).val().toString().keyslug()+"]']").attr('disabled', !jQuery(this).prop('checked'));
						jQuery(":input[name='login_redirect_url["+jQuery(this).val()+"]']").attr('disabled', !jQuery(this).prop('checked'));
					});
					// enable/disable logout redirect					
					jQuery("#membership_types_list :checkbox[name='update_logout_redirect_url[]']").bind('click', function(){										
						jQuery(":input[name='logout_redirect_url["+jQuery(this).val()+"]']").attr('disabled', !jQuery(this).prop('checked'));
					});										
				});	
			}	
