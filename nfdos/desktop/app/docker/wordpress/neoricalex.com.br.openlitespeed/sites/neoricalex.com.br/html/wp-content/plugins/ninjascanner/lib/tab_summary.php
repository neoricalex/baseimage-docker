...
<form method="post">
	...
	&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="button" id="cancel-scan" onClick="nscanjs_cancel_scan(<?php echo "'{$nscan_key}', 1" ?>)" name="cancel-scan" class="button-secondary" value="<?php _e('Cancel Scan', 'ninjascanner') ?>"<?php echo $cancel_button ?> />
