	...
	final class Restrict_Content_Pro {
		...
		private function setup_constants() {
			...
			if ( ! defined( 'RCP_PLUGIN_VERSION' ) ) {
				define( 'RCP_PLUGIN_VERSION', '3.5.2' );
			}
		...
		private function include_files() {
			...
			require_once RCP_PLUGIN_DIR . 'includes/component-functions.php';
			require_once RCP_PLUGIN_DIR . 'includes/class-rcp-component.php';
			...
			require_once RCP_PLUGIN_DIR . 'includes/database/engine/class-compare.php';
			require_once RCP_PLUGIN_DIR . 'includes/database/engine/class-date.php';
			...
			require_once RCP_PLUGIN_DIR . 'includes/database/logs/class-logs-table.php';
			require_once RCP_PLUGIN_DIR . 'includes/database/membership-counts/class-membership-counts-table.php';
			require_once RCP_PLUGIN_DIR . 'includes/database/membership-levels/class-membership-levels-table.php';
			...
			require_once RCP_PLUGIN_DIR . 'includes/database/logs/class-log-query.php';
			require_once RCP_PLUGIN_DIR . 'includes/database/membership-counts/class-membership-count-query.php';
			require_once RCP_PLUGIN_DIR . 'includes/database/membership-levels/class-membership-level-query.php';
			...
			require_once RCP_PLUGIN_DIR . 'includes/database/logs/class-logs-schema.php';
			require_once RCP_PLUGIN_DIR . 'includes/database/membership-counts/class-membership-counts-schema.php';
			require_once RCP_PLUGIN_DIR . 'includes/database/membership-levels/class-membership-levels-schema.php';
			...
			require_once( RCP_PLUGIN_DIR . 'includes/gateways/gateway-actions.php' );
			...
			require_once( RCP_PLUGIN_DIR . 'includes/logs/class-log.php' );
			require_once( RCP_PLUGIN_DIR . 'includes/logs/log-functions.php' );
			...
			require_once( RCP_PLUGIN_DIR . 'includes/membership-levels/class-rcp-membership-level.php' );
			require_once( RCP_PLUGIN_DIR . 'includes/membership-levels/membership-level-functions.php' );
			...
			require_once( RCP_PLUGIN_DIR . 'includes/deprecated/subscription-functions.php' );
		...
		private function include_admin() {
			...
			require_once( RCP_PLUGIN_DIR . 'includes/admin/export/export-actions.php' );
			...
			require_once( RCP_PLUGIN_DIR . 'includes/admin/deprecated-admin-functions.php' );
