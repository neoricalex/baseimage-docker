...
define('MGM_PRODUCT_VERSION', '1.8.71');

// product id, required, 1, 2, 3, old original_id
define('MGM_PRODUCT_ID', 1822);

// product guid, required, new, @see docs/DIST.TXT
define('MGM_PRODUCT_GUID', 'magic-members-trial-license');

// product name
define('MGM_PRODUCT_NAME', 'Trial License');

// product brand, required
define('MGM_PRODUCT_BRAND', 'magic-members');

// product purchase url, required if not single license
define('MGM_PRODUCT_URL', 'products-page/plugins/magic-members-trial-license/');
